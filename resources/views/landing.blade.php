...
<div class="container d-flex justify-content-center mt-5">
    <div class="card shadow-lg p-4" style="width: 100%; max-width: 800px;">
        <h2 class="text-center mb-4">Landing Page</h2>
    ...
    <div class="mt-4" id="project-details" class="d-flex justify-content-center">
...
<script>
    $(document).ready(function () {
        $('#service-select').change(function () {
            let service = $(this).val();  // Get selected service
